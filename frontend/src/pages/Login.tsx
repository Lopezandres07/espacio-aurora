      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-aurora-accent/50">
        <div className="p-8 sm:p-12">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-serif font-bold text-aurora-dark">Bienvenida</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-aurora-text">
                  Recordarme
                </label>
              </div>

              <div className="text-sm">
                <a href="#" className="font-medium text-aurora-primary hover:text-aurora-dark transition-colors">
