        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          ...
          >
            <div className="p-6 bg-aurora-accent border-b border-aurora-light">
              <h3 className="font-serif text-xl font-bold text-aurora-dark text-center">Espacio Aurora</h3>
              <p className="text-sm text-aurora-text text-center mt-1">Realza tu esencia</p>
            </div>
